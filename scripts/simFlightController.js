...
import { simulateFleet } from "./simFleet.js?v=4.40";
import { shipPositionAt } from "./simTransfer.js?v=4.40";
import { extractRootedBackbone, buildShipNodes, computeShipAccessStats } from "./simShipLinks.js?v=4.40";
