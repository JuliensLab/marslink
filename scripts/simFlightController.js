...
import { simulateFleet } from "./simFleet.js?v=4.38";
import { shipPositionAt } from "./simTransfer.js?v=4.38";
import { extractRootedBackbone, buildShipNodes, computeShipAccessStats } from "./simShipLinks.js?v=4.38";
