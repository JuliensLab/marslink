...
import { simulateFleet } from "./simFleet.js?v=4.33";
import { shipPositionAt } from "./simTransfer.js?v=4.33";
import { extractRootedBackbone, buildShipNodes, computeShipAccessStats } from "./simShipLinks.js?v=4.33";
