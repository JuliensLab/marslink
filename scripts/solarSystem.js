...
//   { name: "Mercury", size: 1, distance: 10, revolutionSpeed: 0.01, rotationSpeed: 0.02, texturePath: "img/textures/2k_mercury.jpg" },
//   {
//     name: "Venus",
//     size: 1.5,
//     distance: 15,
...
//   },
//   { name: "Earth", size: 2, distance: 20, revolutionSpeed: 0.006, rotationSpeed: 0.01, texturePath: "img/textures/2k_earth_daymap.jpg" },
// ];

// textures: https://www.solarsystemscope.com/textures/
// elements: https://nssdc.gsfc.nasa.gov/planetary/factsheet/   https://ssd.jpl.nasa.gov/planets/orbits.html

export const solarSystemData = {
  convertRadius: function (km) {
    return Math.sqrt(km) / 100 / 2;
  },
  background: { diameterKm: 6000000000, texturePath: "img/textures/8k_stars.jpg" },
  sun: {
    diameterKm: 1392700,
    rotationHours: 27,
